...
class RoomItem2(val corespondent:String ,val room:String, val message:String,val timestamp:String): Item<GroupieViewHolder>() {
    ...
    override fun getLayout() = R.layout.room2
}